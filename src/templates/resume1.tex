...
\begin{center}
    ...
    \small \raisebox{-0.1\height} \jasphone ~ \href{mailto:\email}{\raisebox{-0.2\height}\faEnvelope\  \underline{\email}}
    \href{\linkedin}{\raisebox{-0.2\height}\faLinkedin\ \underline{\linkedin}}  ~
    \href{\github}{\raisebox{-0.2\height}\faGithub\ \underline{\github}}
    \href{\portfolio}{\raisebox{-0.2\height}\faLink\ \underline{\portfolio}}
    \vspace{-8pt}
\end{center}
}
